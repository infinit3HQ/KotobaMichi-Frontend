        ...
        <div className="container mx-auto px-4 py-16 md:py-24 text-center">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
            ...
            <Button asChild variant="outline" size="lg">
              <Link to="/words">Browse words</Link>
            </Button>
          </div>
          ...
          <div className="mt-6 text-sm text-muted-foreground">
            Prefer a challenge? {" "}
            <Link to="/quizzes" className="font-medium text-primary underline-offset-4 hover:underline">
              Jump into a quiz
            </Link>
          </div>
        </div>
          ...
          <div className="flex flex-col items-center gap-4 px-6 py-10 text-center md:flex-row md:justify-between md:text-left">
            ...
            <div className="flex gap-3">
              ...
              <Button asChild variant="outline">
                <Link to="/auth/login">I already have one</Link>
              </Button>
            </div>
          </div>
        </div>
      ...
      <CardContent className="flex h-full flex-col gap-4 p-6">
        ...
        <div className="mt-auto">
          <Button asChild variant="ghost" className="px-0">
            <Link to={cta.to} className="inline-flex items-center gap-1">
              {cta.label}
              <ArrowRight className="h-4 w-4" />
            </Link>
          </Button>
